...
def calculate_credit_score(
    ...
    alternative_income: float = 50000.0,  # Default constant value
    ...
    Args:
        ...
        alternative_income: Alternative income amount (default: $50,000)
        education_score: Education/licenses score 0-100 (default: 75)
    
    Returns:
        Dict with credit_score (0-100) and breakdown of components
    """
    # 1. Financial Accounts Score (40%) - Investments, recurring payments, phone, rent
    financial_accounts_score = _calculate_financial_accounts_score(
        transactions, accounts, investments
    )
    
    # 2. Alternative Income Score (30%) - Based on alternative_income amount
    alternative_income_score = _calculate_alternative_income_score(alternative_income)
    
    # 3. Education/Licenses Score (10%) - Use provided constant
    education_licenses_score = education_score
    
    # 4. Cash Flow Volatility Score (20%) - Based on transaction patterns
    cash_flow_volatility_score = _calculate_cash_flow_volatility_score(transactions)
